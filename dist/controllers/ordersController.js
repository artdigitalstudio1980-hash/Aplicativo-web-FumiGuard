...
var createOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, serviceId, plagueType, areaSize, propertyType, userId, service, calculatedPrice, totalPrice, order, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body, serviceId = _a.serviceId, plagueType = _a.plagueType, areaSize = _a.areaSize, propertyType = _a.propertyType;
...
var createPaymentIntent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, order, paymentIntent, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
